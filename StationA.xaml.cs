...
namespace SigknowShopFloor
{
    ...
    /// <summary>
    /// Interaction logic for StationA.xaml
    /// </summary>
    public partial class StationA : Window
    {
        ...
        public StationA(MainWindow mw): this()
        {
            mainwindow = mw;
        }
        ...
        {
            //Label lbStation = new Label();
            lbStation.Content = StationName.gStationA;
        ...
        private void tbPCBASN_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.Key.ToString() == "Return")
            {
                ...
                {
                    //TODO 
                    //Utils.ValidateSN(Global.gPCBASN, DBColPrefix.gStationA, DBColPrefix.gStationB);
                    tbRESULT.Background = System.Windows.Media.Brushes.LightGray;
        ...
        private void tbRESULT_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.Key.ToString() == "Return")
            {
                ...
                try
                {
                    ...
                    Utils.ValidateResult(DBColPrefix.gStationA, tbPCBASN.Text, Global.gResult);
                    ...
                    if (Global.gResult == Barcode.OK)
                    {
                        ...
                        if (Global.gREWORK)
                        {
                            if (!Global.gSKIP)
                            {
                                Utils.dbupdate(tbPCBASN.Text, DBColPrefix.gStationA, Utils.barcode2dbbool(Global.gResult));
                                if (!Global.gINITIALRUN)
                                    Utils.dbchangehistory(tbPCBASN.Text, "", DBColPrefix.gStationA, Utils.barcode2dbbool(Global.gResult));
                            }
                        }
                        else
                        {
