...
namespace SigknowShopFloor
{
    ...
    /// <summary>
    /// Interaction logic for StationC.xaml
    /// </summary>
    public partial class StationC : Window
    {
        ...
        public StationC(MainWindow mw): this()
        {
            mainwindow = mw;
        }
        ...
        {
            //Label lbStation = new Label();
            lbStation.Content = StationName.gStationC;
        ...
        private void tbPCBASN_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.Key.ToString() == "Return")
            {
                ...
                {
                    tbRESULT.Background = System.Windows.Media.Brushes.LightGray;
                    Utils.ValidateSN(Global.gPCBASN, DBColPrefix.gStationB);
                    tbRESULT.Focus();
                    tbRESULT.Clear();
                }
        ...
        private void tbRESULT_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.Key.ToString() == "Return")
            {
                ...
                try
                {
                    ...
                    Utils.ValidateResult(DBColPrefix.gStationC, tbPCBASN.Text, Global.gResult);
                    ...
                    if (Global.gResult == Barcode.OK)
                    {
                        ...
                        if (Global.gREWORK)
                        {
                            if (!Global.gSKIP)
                            {
                                Utils.dbupdate(tbPCBASN.Text, DBColPrefix.gStationC, Utils.barcode2dbbool(Global.gResult));
                                if (!Global.gINITIALRUN)
                                    Utils.dbchangehistory(tbPCBASN.Text, "", DBColPrefix.gStationC, Utils.barcode2dbbool(Global.gResult));
                            }
                        }
                        else
                        {
